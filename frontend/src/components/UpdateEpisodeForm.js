...
const UpdateEpisodeForm = () => {
  ...
  const handleAnimeChange = (selectedOption) => {
    ...
    if (selectedOption) {
      setEpisodeNumber(selectedOption.lastPublishedEpisode - 1 || '');
  ...
  return (
    <div className="w-full h-full p-4 bg-gray-700 rounded-lg">
      <h2 className="text-2xl text-white mb-4">Update Episode</h2>
        ...
        <div className="flex space-x-4">
          ...
          <label className="inline-flex items-center">
            <input
              ...
              className="form-radio text-blue-500 h-5 w-5"
            />
            <span className="ml-2 text-gray-300">Final</span>
          </label>
        </div>
      </div>
